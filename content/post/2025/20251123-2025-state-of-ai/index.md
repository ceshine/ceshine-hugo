...
title: "Reading the State of AI in 2025 Report from McKinsey"
description: ""
tags:
  - ai
  - industry_news
...
This first blog post is about my thoughts after reading the McKinsey & Company report "[The State of AI in 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai)." It provides a useful overview of the current adoption of AI in the industry (with some caveats that I'll mention) and resonates with my experience in recent years.
...
1. AI and ML are paradigm-shifting technologies that have been transforming industries since the deep learning revolution around 2015 (Karpathy's 2017 ["Software 2.0"](https://karpathy.medium.com/software-2-0-a64152b37c35) article and his 2025 ["Software 3.0"](https://www.youtube.com/watch?v=LCEmiRjPEtQ) talk provide detailed accounts of this paradigm shift). **The most effective way to capitalize on this trend is to redesign applicable workflows to incorporate AI and ML technologies rather than simply augmenting existing workflows.**
...
[The report](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) provided the following data that validate the aforementioned beliefs:
...
<div style="max-width: 700px; margin-left: auto; margin-right: auto;">{{< figure src="exhibit_1.png" caption="Exhibit 1 from the report" >}}</div>
